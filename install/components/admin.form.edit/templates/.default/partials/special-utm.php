...
$this->addExternalCss('/bitrix/css/ligacom.feed/ui/collapse.css');
$this->addExternalJs('/bitrix/js/ligacom.feed/ui/collapse.js');
...
$langUtm = [
	'TOGGLE' => $hasValue
		? Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_UTM_TOGGLE_FILL')
		: Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_UTM_TOGGLE'),
	'TOGGLE_ALT' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_UTM_TOGGLE_ALT')
];
