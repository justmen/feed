...
$this->addExternalJs('/bitrix/js/ligacom.feed/field/filter/collection.js');
$this->addExternalJs('/bitrix/js/ligacom.feed/field/filter/item.js');

$lang = [
	'NAME_TOGGLE' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_NAME_TOGGLE'),
	'LEFT_COUNT' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_LEFT_COUNT'),
	'LEFT_COUNT_PROGRESS' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_LEFT_COUNT_PROGRESS'),
	'LEFT_COUNT_FAIL' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_LEFT_COUNT_FAIL'),
	'LEFT_COUNT_EMPTY' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_LEFT_COUNT_EMPTY'),
	'PRODUCT_1' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_PRODUCT_1'),
	'PRODUCT_2' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_PRODUCT_2'),
	'PRODUCT_5' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_PRODUCT_5'),
];
$langStatic = [
	'DELIVERY_EDIT_BUTTON' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_DELIVERY_EDIT'),
	'ADD_BUTTON' => isset($arParams['LANG_ADD_BUTTON']) ? $arParams['LANG_ADD_BUTTON'] : Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_ADD_BUTTON'),
	'ADD_BUTTON_TOOLTIP' => isset($arParams['LANG_ADD_BUTTON']) ? $arParams['LANG_ADD_BUTTON_TOOLTIP'] : Loc::getMessage('LIGACOM_FEED_T_ADMIN_FIELD_FILTER_ADD_BUTTON_TOOLTIP'),
];
...
<script>
	(function() {
		...
		utils.registerLang(<?= Ligacom\Feed\Utils::jsonEncode($lang, JSON_UNESCAPED_UNICODE); ?>, 'LIGACOM_FEED_FIELD_FILTER_');
	})();
</script>
