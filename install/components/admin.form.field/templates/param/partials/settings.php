...
/** @var $tag Feed\Export\Xml\Tag\Base */
...
if ($settings !== null)
{
	...
	foreach ($settings as $settingName => $setting)
	{
		...
		switch ($setting['TYPE'])
		{
			...
			case 'param':
				$defaultSource = isset($setting['DEFAULT']['TYPE']) ? $setting['DEFAULT']['TYPE'] : Feed\Export\Entity\Manager::TYPE_TEXT;
				...
				$disabledTypes = [
					...
					Feed\Export\Entity\Manager::TYPE_TEMPLATE => true,
				];
