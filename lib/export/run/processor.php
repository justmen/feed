...
class Processor
{
	...
	public function __construct(Feed\Export\Setup\Model $setup, $parameters = [])
	{
		$this->setup = $setup;
	 ...
	 *
	 * @return Feed\Export\Run\Writer\File
	 */
	...
	{
		$iblockSectionType = Feed\Export\Entity\Data::TYPE_IBLOCK_SECTION;
