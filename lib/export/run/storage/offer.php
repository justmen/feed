...
class OfferTable extends Feed\Reference\Storage\Table
{
	public static function getTableName()
	{
		return 'ligacom_feed_export_run_offer';
	}
	...
	public static function getMapDescription()
	{
		...
		{
			$result['ELEMENT_ID']['USER_TYPE']['CLASS_NAME'] = 'Ligacom\Feed\Ui\UserField\IblockElementType';
		}
