...
namespace Ligacom\Feed\Components;
...
{
    protected static $langPrefix = 'LIGACOM_FORM_EDIT_';

    /** @var Feed\Component\Base\EditForm */
    protected $provider;
    ...
    public function executeComponent()
    {
        ...
        catch (Main\SystemException $exception)
        {
			...
			$this->arResult['EXCEPTION_MIGRATION'] = Feed\Migration\Controller::canRestore($exception);
        }
    ...
    public function getProvider($providerType = null)
    {
        if ($this->provider === null)
        {
            ...
            $className = 'Ligacom\Feed\Component\\' . $providerType . '\EditForm';

            if (
                !class_exists($className)
                || !is_subclass_of($className, 'Ligacom\Feed\Component\Base\EditForm')
            )
            {
