                ...
                <div class="b-form-section">
                    ...
                    foreach ($fieldValue as $promoProduct)
                    {
                        ...
                        <h3 class="b-heading level--3 <?= $promoProductIndex > 0 ? 'spacing--2x1' : 'pos--top'; ?>">
                            <?= Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_PROMO_PRODUCT_IBLOCK_SECTION', [
                        ...
                        <div class="b-form-panel">
                            <div class="b-form-panel__section fill--primary b-compensate compensate--1x1">
                                <?
                                $APPLICATION->IncludeComponent('ligacom.feed:admin.form.field', 'filter', [
                                    ...
                                    'LANG_ADD_BUTTON' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_PROMO_PRODUCT_ADD_BUTTON'),
                                    'LANG_ADD_BUTTON_TOOLTIP' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_PROMO_PRODUCT_ADD_BUTTON_TOOLTIP'),
                                ...
                                if ($hasExportGiftFlag)
                                {
                                    $userField = [
                                        'USER_TYPE' =>
                                            [ 'CLASS_NAME' => 'Ligacom\Feed\Ui\UserField\BooleanType' ]
                                            + $USER_FIELD_MANAGER->GetUserType('boolean'),
                                        'FIELD_NAME' => $promoProductInputName . '[EXPORT_GIFT]',
                                        'LIST_COLUMN_LABEL' => Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_PROMO_PRODUCT_EXPORT_GIFT_LABEL'),
                                        'MANDATORY' => 'N',
                                        'MULTIPLE' => 'N',
                                        'EDIT_IN_LIST' => 'Y',
                                    ...
                                    <div class="spacing--1x1">
                                        ...
                                        <label for="<?= $userField['FIELD_NAME']; ?>">
                                            <?= Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_SPECIAL_PROMO_PRODUCT_EXPORT_GIFT_LABEL'); ?>
                                        </label>
                                    </div>
                                    <?
                                }
					...
					if ($field['FIELD_NAME'] === 'PROMO_PRODUCT')
					{
						...
						<div class="b-admin-message-list">
							<?
							echo BeginNote();
							echo Loc::getMessage('LIGACOM_FEED_T_ADMIN_FORM_EDIT_PROMO_PRODUCT_COLLISION');
							echo EndNote();
							?>
						</div>
						<?
