 ...
 * Sample:
 *
 * CModule::includeModule('ligacom.feed');
 * $rsOpinions = new Feed\Api\Content\ModelOpinions('46fe7ca9-f82a-4a6a-bf9a-ff9b2ec76bae');
 * print_r($rsOpinions->get('1727683629'));
 */
namespace Ligacom\Feed\Api\Content;
