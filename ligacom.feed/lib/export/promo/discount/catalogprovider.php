...
class CatalogProvider extends SaleProvider
{
    ...
    {
        return Main\ModuleManager::isModuleInstalled('catalog') && !Feed\Utils::isOnlySaleDiscount();
    }

    public static function getTitle()
    {
        return Feed\Config::getLang('EXPORT_PROMO_PROVIDER_CATALOG_DISCOUNT_TITLE');
    }

    public static function getDescription()
    {
        return Feed\Config::getLang('EXPORT_PROMO_PROVIDER_CATALOG_DISCOUNT_DESCRIPTION');
    }
    ...
    public function detectPromoType()
    {
        ...
        {
            $result = Feed\Export\Promo\Table::PROMO_TYPE_PROMO_CODE;
        }
        else
        {
            $result = Feed\Export\Promo\Table::PROMO_TYPE_FLASH_DISCOUNT;
        }
    ...
    {
        $discountUnit = Feed\Export\Promo\Table::DISCOUNT_UNIT_CURRENCY;
        ...
        switch ($this->getField('VALUE_TYPE'))
        {
            case Catalog\DiscountTable::VALUE_TYPE_PERCENT:
                $discountUnit = Feed\Export\Promo\Table::DISCOUNT_UNIT_PERCENT;
            break;
