...
class Table extends Feed\Reference\Storage\Table
{
	...
	{
		return 'ligacom_feed_export_promo_gift';
	}
	...
	public static function getMap()
	{
		return [
			...
			new Main\Entity\ReferenceField('FILTER', Feed\Export\Filter\Table::getClassName(), [
				'=ref.ENTITY_TYPE' => [ '?', Feed\Export\Filter\Table::ENTITY_TYPE_PROMO_GIFT ],
	...
	public static function getReference($primary = null)
	{
		return [
			'FILTER' => [
				...
				'LINK' => [
					'ENTITY_TYPE' => Feed\Export\Filter\Table::ENTITY_TYPE_PROMO_GIFT,
					'ENTITY_ID' => $primary
				]
			]
		];
