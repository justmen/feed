...
class Currencies extends Base
{
	...
	{
		return Feed\Export\Run\Storage\CurrencyTable::getClassName();
	}

	protected function getDataLogEntityType()
	{
		return Feed\Logger\Table::ENTITY_TYPE_EXPORT_RUN_CURRENCY;
	}
	...
	/**
	 * @return Ligacom\Feed\Type\CurrencyType
	 */
	protected function getType()
	{
		return Feed\Type\Manager::getType(
