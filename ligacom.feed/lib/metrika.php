...
class Metrika
{
	...
	public static function reachGoal($goal)
	{
		...
		if (!isset($_SESSION['LIGACOM_FEED_METRIKA_GOAL_READY'][$goal]))
		{
			if (!isset($_SESSION['LIGACOM_FEED_METRIKA_GOAL_READY']))
			{
				$_SESSION['LIGACOM_FEED_METRIKA_GOAL_READY'] = [];
			}

			$_SESSION['LIGACOM_FEED_METRIKA_GOAL_READY'][$goal] = true;
	...
	public static function load()
	{
		...
		$assets->addJs('/bitrix/js/ligacom.feed/metrika.js');
