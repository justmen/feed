...
abstract class Table extends Main\Entity\DataManager
{
	...
	/**
	 * ���� = ���� �����
	 * �������� = ������� LINK_FIELD => ��������� �� ������� ��������, LINK => ���� ��� �����, TABLE => Table::class
	 *
		...
		foreach ($entity->getFields() as $field)
		{
			...
			switch (true)
			{
				case ($field instanceof Main\Entity\EnumField): // enum
					...
					$userTypeClassName = 'Ligacom\Feed\Ui\UserField\EnumerationType';
					$userField['VALUES'] = [];
					$userField['SETTINGS'] = [
				...
				case ($field instanceof Main\Entity\BooleanField): // boolean
					...
					$userType = 'boolean';
					$userTypeClassName = 'Ligacom\Feed\Ui\UserField\BooleanType';
					$userField['SETTINGS'] = [
						'DEFAULT_VALUE' => $field->getDefaultValue()
					];
				...
				case ($field instanceof Main\Entity\ReferenceField):
					...
					$userType = 'enumeration';
					$userTypeClassName = 'Ligacom\Feed\Ui\UserField\ReferenceType';
	...
	public static function getName()
	{
		...
		return Feed\Config::getLang($langKey);
	}
